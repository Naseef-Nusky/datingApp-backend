...
import { applyZodiacToLifestyle } from '../utils/zodiac.js';

function applyAutomaticZodiac(profileInstance) {
  if (!profileInstance.lifestyle) return;
  profileInstance.lifestyle = applyZodiacToLifestyle(profileInstance.lifestyle);
}
